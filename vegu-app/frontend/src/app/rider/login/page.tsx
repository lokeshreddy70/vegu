  ...
  return (
    <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center px-5 relative overflow-hidden">
      ...
      <div className="text-center mb-10 relative z-10">
        ...
        <div>
          <h1 className="text-white text-[40px] font-black tracking-[-2px] leading-none">VEGU</h1>
      ...
      {mode === 'login' && (
        <div className="w-full max-w-sm relative z-10">
          <div className="bg-white/[0.04] backdrop-blur-2xl border border-white/[0.07] rounded-[28px] p-6">
            <p className="text-white font-bold text-lg mb-0.5">Sign in</p>
            <p className="text-white/35 text-sm mb-6">Enter your credentials to continue</p>
            ...
            <p className="text-center text-xs text-white/25 mt-5">
              New rider?{' '}
              <a href="/rider/register" className="text-white/50 hover:text-white transition-colors font-semibold">
                Register here
              </a>
            </p>
          </div>
      ...
      {mode === 'upgrade' && (
        <div className="w-full max-w-sm relative z-10">
          <div className="bg-white/[0.04] backdrop-blur-2xl border border-white/[0.07] rounded-[28px] p-6">
            <div className="mb-5">
              <p className="text-white font-bold text-lg mb-1">One more step</p>
              <p className="text-white/35 text-sm">Select your vehicle to join as a rider</p>
            </div>
            ...
            <button type="button" onClick={onUpgrade} disabled={upgrading}
              className="w-full flex items-center justify-center gap-2 bg-white text-black font-bold py-3.5 rounded-2xl text-sm disabled:opacity-40 active:scale-[0.98] transition-all">
